...
import RequestsPage   from "../../component1/pages/RequestsPage";
import ProfilePage    from "../../component1/pages/ProfilePage";
import FeedbackPage   from "../../component1/pages/FeedbackPage";
...
export default function StudentPortal() {
  ...
  const canAccessRequestsAndFeedback = normalizedRole !== "batchrep";
  ...
  const renderPage = () => {
    switch (active) {
      ...
      case "requests":  return canAccessRequestsAndFeedback ? <RequestsPage /> : <DashboardPage setActive={setActive} onNavigate={handleNavigate}/>;
      case "feedback":  return canAccessRequestsAndFeedback ? <FeedbackPage /> : <DashboardPage setActive={setActive} onNavigate={handleNavigate}/>;
